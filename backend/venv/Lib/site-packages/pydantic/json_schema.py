...
class GenerateJsonSchema:
    ...
    def update_with_validations(
        ...
        Args:
            ...
            mapping: A mapping from backend.core_schema attribute names to the corresponding JSON schema attribute names.
        """
    ...
    class ValidationsMapping:
        """This class just contains mappings from backend.core_schema attribute names to the corresponding
